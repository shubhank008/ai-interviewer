...
OPERATIONS: tuple[RehearsalOperation, ...] = (
    ...
    RehearsalOperation("storage-ftp-lifecycle-ok", "storage-ftp", "ftp", ("FTP_HOST", "FTP_USER", "FTP_PASSWORD")),
    ...
    RehearsalOperation("browser-audio-transport-ok", "browser-audio", "selected-browser-transport", ("PHASE16_BROWSER_URL",)),
    RehearsalOperation("stt-partial-final-timestamps-ok", "stt", "whisperx-small", ("STT_PROVIDER", "STT_MODEL")),
    RehearsalOperation("llm-interviewer-stream-ok", "llm-interviewer", "openrouter", ("OPENROUTER_API_KEY", "LLM_MODEL")),
    ...
    RehearsalOperation("llm-evaluation-score-ok", "llm-evaluation", "openrouter", ("OPENROUTER_API_KEY", "LLM_MODEL")),
    RehearsalOperation("retention-deletion-ok", "retention-deletion", "selected-storage", ("FIREBASE_PROJECT_ID",)),
    RehearsalOperation("browser-recruiter-journey-ok", "browser-recruiter", "firebase/browser/providers", ("PHASE16_BROWSER_URL", "FIREBASE_PROJECT_ID")),
    RehearsalOperation("browser-technical-journey-ok", "browser-technical", "firebase/browser/providers", ("PHASE16_BROWSER_URL", "FIREBASE_PROJECT_ID")),
